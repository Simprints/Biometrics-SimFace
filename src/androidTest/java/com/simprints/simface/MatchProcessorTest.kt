...
class VerificationTest {
    ...
    fun score_between_identical_vectors_should_be_one() {
        val array1 = floatArrayOf(1.0f, 0.0f, 0.0f)
        val array2 = floatArrayOf(1.0f, 0.0f, 0.0f)

        val distance = simFace.matchProcessor.matchScore(array1, array2)
    ...
    fun score_between_orthogonal_vectors_should_be_one_half() {
        val array1 = floatArrayOf(1.0f, 0.0f)
        val array2 = floatArrayOf(0.0f, 1.0f)
    ...
    fun score_between_opposite_vectors_should_be_zero() {
        val array1 = floatArrayOf(1.0f, 0.0f)
        val array2 = floatArrayOf(-1.0f, 0.0f)
    ...
    fun score_between_arbitrary_vectors_should_be_between_zero_and_one() {
        val array1 = floatArrayOf(1.0f, 2.0f, 3.0f)
        val array2 = floatArrayOf(4.0f, 5.0f, 6.0f)
...
class IdentificationTest {
    ...
    fun score_map_should_be_ordered_by_distance() {
        val referenceArray = floatArrayOf(1.0f, 0.0f)
        val arrayList = listOf(
            floatArrayOf(-1.0f, 0.0f),    // opposite to referenceArray
            floatArrayOf(1.0f, 0.0f),    // identical to referenceArray
            floatArrayOf(0.0f, 1.0f),    // orthogonal to referenceArray
            floatArrayOf(0.707f, 0.707f) // 45 degrees to referenceArray
        )
